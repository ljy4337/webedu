...
<body>
		...
		<script>
			...
			function validationCheck(){
				...
				if(bcontent.value.trim().length > 500){
			...
			<form name="frm" action="Write.do" method="post">
				<table summary="게시글작성">
					...
					<thead>
						<tr>
							<th>제목</th>
							<td ><input name="btitle" id="btitle" type="text" placeholder="제목을 입력하세요.(30자 이하)"></td>
						</tr>
						<tr>
							<th>작성자</th>
							...
							${sessionScope.nickname } / (${sessionScope.id })
							<!-- <input name="bnickname" id="bnickname" type="text" placeholder="작성자(10자 이하)"> --></td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
								<textarea name="bcontent" id="bcontent" cols="50" rows="15" placeholder="내용을 입력하세요.(100자 이하)"></textarea>
							</td>
						</tr>
